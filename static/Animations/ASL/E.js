export const E = () => {
  ...
  let finalanimations = [];
    ...
    // Curl all fingers moderately (not tight like a fist)
    animations2.push(["mixamorigRightHandIndex1", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandIndex2", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandIndex3", "rotation", "z", Math.PI / 2.5, "+"]);

    animations2.push(["mixamorigRightHandMiddle1", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandMiddle2", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandMiddle3", "rotation", "z", Math.PI / 2.5, "+"]);

    animations2.push(["mixamorigRightHandRing1", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandRing2", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandRing3", "rotation", "z", Math.PI / 2.5, "+"]);

    animations2.push(["mixamorigRightHandPinky1", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandPinky2", "rotation", "z", Math.PI / 2.5, "+"]);
    animations2.push(["mixamorigRightHandPinky3", "rotation", "z", Math.PI / 2.5, "+"]);
