export const W = () => {
  ...
  let finalanimations = [];
    ...
    animations2.push(["mixamorigRightHandIndex1", "rotation", "y", Math.PI/24, "+"]);

    // Middle finger (extended)
    animations2.push(["mixamorigRightHandMiddle1", "rotation", "y", - Math.PI/24, "-"]);
    ...
    // Thumb (touching pinky finger base)
    animations2.push(["mixamorigRightHandThumb1", "rotation", "y", - Math.PI/2.5, "-"]);
