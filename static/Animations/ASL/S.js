export const S = () => {
  ...
  let finalanimations = [];
    ...
    animations2.push(["mixamorigRightHandIndex1", "rotation", "z", Math.PI / 1.5, "+"]);
    animations2.push(["mixamorigRightHandIndex2", "rotation", "z", Math.PI / 1.5, "+"]);
    animations2.push(["mixamorigRightHandIndex3", "rotation", "z", Math.PI / 1.5, "+"]);
    ...
    animations2.push(["mixamorigRightHandRing1", "rotation", "z", Math.PI / 1.5, "+"]);
    animations2.push(["mixamorigRightHandRing2", "rotation", "z", Math.PI / 1.5, "+"]);
    animations2.push(["mixamorigRightHandRing3", "rotation", "z", Math.PI / 1.5, "+"]);

    // Pinky (extended)
    animations2.push(["mixamorigRightHandPinky1", "rotation", "z", Math.PI / 1.5, "+"]);
    animations2.push(["mixamorigRightHandPinky2", "rotation", "z", Math.PI / 1.5, "+"]);
    animations2.push(["mixamorigRightHandPinky3", "rotation", "z", Math.PI / 1.5, "+"]);

    animations2.push(["mixamorigRightHandThumb1", "rotation", "y", Math.PI/24, "+"]);
    animations2.push(["mixamorigRightHandThumb2", "rotation", "y", -Math.PI/2, "-"]);
    animations2.push(["mixamorigRightHandThumb3", "rotation", "y", -Math.PI/4, "-"]);
