export const R = () => {
  ...
  let finalanimations = [];
    ...
    let animations2 = []
    animations2.push(["mixamorigRightHandIndex2", "rotation", "z", Math.PI/8, "+"]);
    ...
    animations2.push(["mixamorigRightHand", "rotation", "x", -Math.PI/2.3, "-"]);
    ...
    animations2.push(["mixamorigLeftHand", "rotation", "x", -Math.PI/1.3, "-"]);
