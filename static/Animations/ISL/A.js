export const A = () => {
    ...
    animations2.push(["mixamorigLeftHand", "rotation", "x", Math.PI/2, "+"]);
    animations2.push(["mixamorigLeftHand", "rotation", "z", Math.PI/6, "+"]);
    animations2.push(["mixamorigLeftHand", "rotation", "y", Math.PI/9, "+"]);

    animations2.push(["mixamorigLeftForeArm", "rotation", "x", Math.PI/10, "+"]);
    animations2.push(["mixamorigLeftForeArm", "rotation", "z", -Math.PI/18, "-"]);

    animations2.push(["mixamorigLeftArm", "rotation", "x", -Math.PI/11, "-"]);
    ...
    animations2.push(["mixamorigRightForeArm", "rotation", "z", Math.PI/4, "+"]);
    animations2.push(["mixamorigRightForeArm", "rotation", "x", -Math.PI/36, "-"]);

    animations2.push(["mixamorigRightArm", "rotation", "x", -Math.PI/9, "-"]);
    animations2.push(["mixamorigRightArm", "rotation", "y", -Math.PI/72, "-"]);
