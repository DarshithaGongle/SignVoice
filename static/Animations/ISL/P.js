export const P = () => {
  ...
  let finalanimations = [];
    ...
    let animations2 = []
    animations2.push(["mixamorigRightHandIndex1", "rotation", "z", Math.PI/4.2, "+"]);
    animations2.push(["mixamorigRightHandIndex2", "rotation", "z", Math.PI/4.2, "+"]);
    animations2.push(["mixamorigRightHandIndex3", "rotation", "z", Math.PI/4.2, "+"]);
    animations2.push(["mixamorigRightHandMiddle1", "rotation", "z", Math.PI/1.5, "+"]);
    animations2.push(["mixamorigRightHandMiddle2", "rotation", "z", Math.PI/1.5, "+"]);
    animations2.push(["mixamorigRightHandMiddle3", "rotation", "z", Math.PI/1.5, "+"]);
    ...
    animations2.push(["mixamorigRightHandThumb1", "rotation", "y", Math.PI/15, "+"]);
    animations2.push(["mixamorigRightHandThumb2", "rotation", "y", -Math.PI/10, "-"]);
    animations2.push(["mixamorigRightHandThumb3", "rotation", "y", -Math.PI/10, "-"]);

    animations2.push(["mixamorigRightHand", "rotation", "z", -Math.PI/5, "-"]);
    animations2.push(["mixamorigRightHand", "rotation", "y", Math.PI/6, "+"]);

    animations2.push(["mixamorigRightForeArm", "rotation", "z", Math.PI/5.3, "+"]);
    ...
    animations2.push(["mixamorigLeftHandMiddle1", "rotation", "z", -Math.PI/1.5, "-"]);
    animations2.push(["mixamorigLeftHandMiddle2", "rotation", "z", -Math.PI/1.5, "-"]);
    animations2.push(["mixamorigLeftHandMiddle3", "rotation", "z", -Math.PI/1.5, "-"]);
    animations2.push(["mixamorigLeftHandRing1", "rotation", "z", -Math.PI/1.6, "-"]);
    animations2.push(["mixamorigLeftHandRing2", "rotation", "z", -Math.PI/1.6, "-"]);
    animations2.push(["mixamorigLeftHandRing3", "rotation", "z", -Math.PI/1.6, "-"]);
    animations2.push(["mixamorigLeftHandPinky1", "rotation", "z", -Math.PI/1.8, "-"]);
    animations2.push(["mixamorigLeftHandPinky2", "rotation", "z", -Math.PI/1.8, "-"]);
    animations2.push(["mixamorigLeftHandPinky3", "rotation", "z", -Math.PI/1.8, "-"]);
    ...
    animations2.push(["mixamorigLeftHand", "rotation", "y", -Math.PI/4, "-"]);

    animations2.push(["mixamorigLeftForeArm", "rotation", "z", -Math.PI/5.85, "-"]);
    animations2.push(["mixamorigLeftForeArm", "rotation", "x", Math.PI/18, "+"]);

    animations2.push(["mixamorigLeftArm", "rotation", "y", -Math.PI/33, "-"]);
    ...
    animations2.push(["mixamorigLeftArm", "rotation", "y", 0, "+"]);
