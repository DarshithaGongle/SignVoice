export const Q = () => {
  ...
  animations2.push(["mixamorigRightHand", "rotation", "z", -Math.PI/4, "-"]);
  ...
  animations2.push(["mixamorigLeftHandIndex1", "rotation", "z", -Math.PI/3, "-"]);
  ...
  animations2.push(["mixamorigLeftHandThumb1", "rotation", "x", Math.PI/10, "+"]);
  animations2.push(["mixamorigLeftHandThumb2", "rotation", "y", Math.PI/10, "+"]);

  animations2.push(["mixamorigLeftHand", "rotation", "y", Math.PI/2.8, "+"]);
  animations2.push(["mixamorigLeftHand", "rotation", "x", Math.PI/3, "+"]);
  ...
  animations2.push(["mixamorigLeftArm", "rotation", "x", -Math.PI/8.3, "-"]);
